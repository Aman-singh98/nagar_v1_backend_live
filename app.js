...
import { centerHistoryRouter, locationMapRouter, reportRouter } from './routes/report.routes.js';
...
app.use('/api/v1/locations', locationMapRouter);
app.use('/api/v1/reports', reportRouter);
app.use('/api/v1/centers',   centerHistoryRouter); 
