...
const routeSchema = new mongoose.Schema(
  {
    ...
    /**
     * Minimum seconds an employee must stay inside a center's geofence
     * for the visit to count. Default: 300s (5 minutes).
     * Configurable per route by the admin/manager.
     */
    minStaySeconds: {
      type: Number,
      default: 5,
      min: [0, "minStaySeconds cannot be negative"],
      max: [3600, "minStaySeconds cannot exceed 1 hour"],
    },
  },
  {
 ...
 */
routeSchema.statics.findActiveByCompany = function (
  companyId,
  managerId = null,
) {
