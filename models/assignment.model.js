...
const visitStatusSchema = new mongoose.Schema(
   {
      ...
      /** When employee entered this center's geofence */
      entryTimestamp: {
         type: Date,
         default: null,
      },

      /** When employee exited this center's geofence */
      exitTimestamp: {
         type: Date,
         default: null,
      },
      ...
      /**
       * Total seconds employee stayed inside geofence.
       * Stored even for rejected drive-through visits.
       */
      durationSeconds: {
         type: Number,
         default: null,
      ...
      /**
       * True if this center was visited out of the prescribed route order.
       * informational only, does not block the visit.
       */
      outOfSequence: {
         type: Boolean,
         default: false,
